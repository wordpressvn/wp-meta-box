<div class="wmb-input wmb-repeater">
    ...
    <div>
            ...
            <?php foreach($option->get_options() as $group_options) { ?>
                <div class="wmb-repeater-option-group">
                    <div class="wmb-repeater-option-group-header">
                        ...
                        <?php
                        $first_render = true;
                        foreach($group_options as $repeater_option) { 
                            if ($first_render) {
                                $first_rendered_content = $repeater_option->render();
                                echo $first_rendered_content;
                                $first_render = false;
                            }
                        }
                        ?>
        ...
        <button type="button" class="button wmb-repeat components-button is-secondary is-small">+ Add Row</button>
    </div>
</div>
